...
public class Profile {
	 ...
	 * @param hs1 - Highscore for level 1
	 * @param hs2 - Highscore for level 2
	 * @param hs3 - Highscore for level 3
	 * @param hs4 - Highscore for level 4
	 * @param hs5 - Highscore for level 5
	 * @param hs6 - Highscore for level 6
	 * @param hs7 - Highscore for level 7
	 * @param hs8 - Highscore for level 8
	 * @param hs9 - Highscore for level 9
	 * @param hs10 - Highscore for level 10
	 */
	...
	public static void setHighscoreToValue(int hScore, int value) throws FileNotFoundException {
		String tempPath = System.getProperty("user.dir") + "\\Profiles\\" + 
				username + ".txt";
		//The writer that clears the file of the profile, and begins to rewrite with correct data
		PrintWriter writer = new PrintWriter(tempPath);
		Profile.clearFile();
		writer.print(username + ",");
		writer.print(userPassword + ",");
		writer.print(highestLevel + ","); 
		writer.print(currentScore + ",");
		//Each case is a highscore level
		if (hScore == 1) {
	...
	/**
	 * This sets all data in a profile to default values
	 * @throws FileNotFoundException
	 */
